...
class PlusParagraphExeScreen extends StatelessWidget {
  @override
    ...
    return Scaffold(
      body: Container(
        ...
        child: Container(
          ...
          child: GetBuilder<PlusParagraphExerciseController>(
            init: PlusParagraphExerciseController(),
            initState: (_) {},
            builder: (_) {
                            ...
                            _.next.value
                                ? _.questionCount.value == 10
                                    ? Get.off(ResultScreen(
                                        ...
                                        named: Routers.plusChoiceParagraphEx,
  ...
  Padding buildNumber(
      PlusParagraphExerciseController _, BuildContext context, int index) {
    return Padding(
  ...
  Padding buildSingleKey(
    ...
    PlusParagraphExerciseController _,
  ) {
    return Padding(
