...
import 'fill_number_inside_array_screen.dart';

class FillArrayCate extends StatelessWidget {
  @override
          ...
          child: Column(
            children: [
              ...
              CustomContainer(
                ...
                borderRadius: 40,
                onTap: () {
                  Get.toNamed(Routers.fillArray, arguments: {'type': 'SM'});
                },
              ),
              ...
              CustomContainer(
                ...
                borderRadius: 40,
                onTap: () {
                  Get.toNamed(Routers.fillArray, arguments: {'type': 'LG'});
                },
              ),
            ],
          ),
