...
import 'package:math/presentation/journeys/minus/exercises/minus_choice_number_excersise.dart';
...
class MinusCategoryScreen extends StatelessWidget {
  @override
          ...
          child: Column(
            children: [
              ...
              CustomContainer(
                ...
                borderRadius: 40,
                onTap: () {
                  Get.to(MinusChoiceNumberExcercises(
                    type: 'small',
                  ));
                },
              ),
