...
class MinusFillAnswerScreen extends StatelessWidget {
      ...
      body: Container(
        ...
        child: Container(
          ...
          child: GetBuilder<MinusFillAnswerController>(
            init: MinusFillAnswerController(),
            initState: (_) {},
            builder: (_) {
              String svgUrl = (_.num1.value > 14 || _.num2.value > 1)
  ...
  Padding buildNumber(
      MinusFillAnswerController _, BuildContext context, int index) {
    return Padding(
