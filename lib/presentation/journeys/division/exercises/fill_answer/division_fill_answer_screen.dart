...
class DivisionFillAnswerScreen extends StatelessWidget {
      ...
      body: Stack(
        children: [
          ...
          Container(
            ...
            child: GetBuilder<DivisionFillAnswerController>(
              init: DivisionFillAnswerController(),
              builder: (_) {
                return Obx(
                  () => Column(
                    children: [
                                  ...
                                  onTap: () {
                                    _.done.value
                                        ? Get.off(ResultScreen(
                                            ...
                                            named: Routers.divisionFillAnswerEx,
  ...
  Padding buildNumber(
      DivisionFillAnswerController _, BuildContext context, int index) {
    return Padding(
  ...
  Padding buildSingleKey(
    ...
    DivisionFillAnswerController _,
  ) {
    return Padding(
