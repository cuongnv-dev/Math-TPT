...
class DivisionExeCategoryScreen extends StatefulWidget {
  final int type;

  const DivisionExeCategoryScreen({Key key, @required this.type})
      : super(key: key);

  @override
  _DivisionExeCategoryScreenState createState() =>
      _DivisionExeCategoryScreenState();
}

class _DivisionExeCategoryScreenState extends State<DivisionExeCategoryScreen> {
  int selectedIndex = 0;
  @override
              ...
              GestureDetector(
                onTap: () {
                  switch (selectedIndex) {
                    case 0:
                      Get.toNamed(Routers.divisionChoiceAnsEx,
                          arguments: {'type': widget.type});
                      break;
                    case 2:
                      Get.toNamed(Routers.divisionFillAnswerEx,
                          arguments: {'type': widget.type});
                      break;
                    case 1:
                      Get.toNamed(Routers.divisionDragImageEx,
                          arguments: {'type': widget.type});
                      break;
                    case 3:
                      Get.toNamed(Routers.divisionChoiceParagraphEx,
                          arguments: {'type': widget.type});
                      break;
                    default:
                  }
