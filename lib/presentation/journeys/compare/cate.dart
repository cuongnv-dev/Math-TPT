...
import 'compare_category_screen.dart';
import 'compare_choice_answer_screen.dart';

class CompareCate extends StatelessWidget {
  @override
          ...
          child: Column(
            children: [
              ...
              CustomContainer(
                ...
                borderRadius: 40,
                onTap: () {
                  Get.to(CompareCategoryScreen(type: 'SM'));
                },
              ),
              ...
              CustomContainer(
                ...
                borderRadius: 40,
                onTap: () {
                  Get.to(CompareCategoryScreen(type: 'LG'));
                },
              ),
            ],
          ),
